...
class CreateTask extends React.Component {
    ...
    render() {
      return(
        <div class="block border-solid p-1 mx-auto mt-2 w-full max-w-lg text-gray-200">
          ...
          <div class ="bg-gray-700 lg:px-4 xl:px-4 md:px-2 border-soild border-4 border-gray-700 ">
           <input class="bg-white focus:outline-none focus:shadow-outline border border-gray-700 rounded-lg py-2 px-4 block w-full appearance-none leading-normal" placeholder="write your new task">
